<div class="col-sm-12">
    <h6 class="text-info"> BORROWER & OPEN DEAL INFO</h6>
    <div class="d-flex justify-content-between align-items-center">

        <div>
            <button style="box-shadow: -5px 0px rgb(0, 174, 255);" type="button" class="btn custom-btn delete_deal"
                data-id="{{ $deal->id }}">
        ...
        <div>
            <button style="box-shadow: -5px 0px rgb(255, 238, 0);" type="button" class="btn custom-btn">
                <i class='fas fa-plus'></i>
                Processor
            </button>
        </div>
        <div>
            <button style="box-shadow: -5px 0px rgb(255, 0, 0);" type="button" data-bs-toggle="modal"
                data-bs-target="#assignModal" class="btn custom-btn">
                <i class='fas fa-plus'></i>
                Lender
            </button>
        </div>
...
<div class="col-sm-12 mt-2">
    <nav>
        <div class="nav nav-tabs" id="nav-tab" role="tablist">
            ...
            <button class="nav-link" id="nav-sales-tab" data-bs-toggle="tab" data-bs-target="#nav-sales" type="button"
                role="tab" aria-controls="nav-sales" aria-selected="false">Sales Notes</button>
    ...
    <div class="tab-content mt-2" id="nav-tabContent">
        <div class="tab-pane fade show active" id="nav-info" role="tabpanel" aria-labelledby="nav-info-tab"
            ...
            <form>
                <div class="row mb-2">
                    <label for="last_contacted" class="col-sm-4 col-form-label">Last
                        Contacted</label>
                    <div class="col-sm-8">
                ...
                <div class="row mb-2">
                    <label for="borrower_status" class="col-sm-4 col-form-label">Borrower
                        Status</label>
                    <div class="col-sm-8">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-8">
                        <input type="text" class="form-control form-control-sm" id="name"
                            value="{{ $deal->marchant_name ?? '' }}">
                    </div>
                </div>
                <div class="row mb-2">
                    <label for="primary_contact" class="col-sm-4 col-form-label">Primary
                        Contact</label>
                    <div class="col-sm-8">
                ...
                <div class="row mb-2">
                    <label for="requested_amount" class="col-sm-4 col-form-label">Requested
                        Amount</label>
                    <div class="col-sm-8">
                ...
                <div class="row mb-2">
                    <label for="date_submitted" class="col-sm-4 col-form-label">Date
                        Submitted</label>
                    <div class="col-sm-8">
