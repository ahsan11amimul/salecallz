  <div class="d-flex justify-content-between align-items-center">
      ...
      <div class="d-flex justify-content-between align-items-center">
          ...
          <div>
              <button style="box-shadow: -5px 0px rgb(0, 119, 255);" type="button" class="btn custom-btn ms-3"
                  data-bs-toggle="modal" data-bs-target="#add_deal">
  ...
  <div>
      @if (isset($submitted))
          ...
          @foreach ($submitted as $item)
              <p class="bg-white {{ $deal->id == $item->id ? 'deal-active' : '' }}">
                  {{ $item->company_name }}</p>
          @endforeach
      @endif
